...
public interface WorkPlanDao extends TreeDao<WorkPlan> {
	 ...
	 * @param userid
	 */
	public void feedbackSave(@Param("remainId") String remainId,@Param("newReply") String newReply, @Param("replyPeopleId") String replyPeopleId,@Param("type") String type);
	/**
	 * 修改结束状态为已处理状态
	 * @param workplanId

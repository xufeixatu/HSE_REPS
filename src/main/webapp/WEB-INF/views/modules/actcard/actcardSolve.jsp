...
<body>
	...
	<form:form id="inputForm" modelAttribute="actcard" action="${ctx}/actcard/actcard/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:checkboxes path="actcardUnsafeEventId" items="${fns:getDictList('')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">不安全分类子类：</label>
			<div class="controls">
				<form:checkboxes path="actcardUnsafeEventChildId" items="${fns:getDictList('')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="closer.id" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">

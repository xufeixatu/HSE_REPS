...
<body>
	...
	<form:form action="" method="post" id="auditingForm" modelAttribute="workPlan" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="commentContent" htmlEscape="false" rows="4"
					maxlength="255" class="input-xxlarge " cssClass="required" readonly="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">打分:</label>
			<div class="controls">
				<form:input path="score" htmlEscape="false" rows="4" disabled="true"

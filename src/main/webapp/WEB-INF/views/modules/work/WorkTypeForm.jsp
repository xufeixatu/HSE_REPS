...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/work/workType/list?id=${workType.parent.id}&parentIds=${workType.parentIds}">工作类别列表</a></li>
		<li class="active"><a href="${ctx}/work/workType/form?id=${workType.id}&parent.id=${workType.parent.id}">工作类别<shiro:hasPermission name="work:workType:edit">${not empty workType.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="work:workType:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="workType" action="${ctx}/work/workType/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">上级工作类别:</label>
			<div class="controls">

...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/risk/riskAccess/">健康安全辨识评价清单列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="riskAccess" action="${ctx}/risk/riskAccess/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>是否重大风险：</label>
				<form:radiobuttons path="isHeaverisk" items="${fns:getDictList('heave_flag')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
			</li>
			<li><label>风险等级：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="riskAccess">
			<tr>
				...
				<td>
					${fns:getDictLabel(riskAccess.judgeTf, 'is_flag', '')}
				</td>

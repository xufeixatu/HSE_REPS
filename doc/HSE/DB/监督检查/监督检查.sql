...
CREATE TABLE `question` (
  ...
  `report_user_id` varchar(64) DEFAULT NULL COMMENT '问题上报者ID',
  `current_audit_user_id` varchar(64) DEFAULT NULL COMMENT '当前处理者ID',
  `checked_office_id` varchar(64) DEFAULT NULL COMMENT '受检单位或部门ID',
  PRIMARY KEY (`id`)

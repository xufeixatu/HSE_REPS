...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/train_course/trainCourse2/">培训课件查看列表</a></li>
		<li class="active"><a href="${ctx}/train_course/trainCourse2/form?id=${trainCourse.id}">上传培训课件<shiro:hasPermission name="train_course:trainCourse2:edit">${not empty trainCourse.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="train_course:trainCourse2:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="trainCourse" action="${ctx}/train_course/trainCourse2/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="coverId" type="files" uploadPath="/train_course/trainCourse2" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="docId" type="files" uploadPath="/train_course/trainCourse2" selectMultiple="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="train_course:trainCourse2:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
